          ...
          <div className="bg-gradient-to-r from-rose-500 via-pink-500 to-rose-600">
            <div className="container mx-auto px-4">
              <nav className="flex items-center justify-between py-2 md:py-4">
                <div className="hidden md:flex flex-wrap items-center justify-center gap-2 md:gap-4 w-full">
                  {navItems.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => handleNavClick(item.id)}
                      className={`text-white hover:text-amber-300 transition-colors duration-300 px-3 py-2 ${
