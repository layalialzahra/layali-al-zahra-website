...
const servicesData = [
    ...
    {
      id: 'combos-packages',
      title: 'Combos & Packages',
      image: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?ixlib=rb-4.1.0&auto=format&fit=crop&q=80&w=1738',
      subservices: [
        { name: 'Silk Smooth – Half Glow (Half Arms + Half Legs + Underarms)', price: 'AED 187.95' },
        { name: 'Silk Smooth – Full Glow (Full Arms + Half Legs + Underarms)', price: 'AED 208.95' },
        { name: 'Silk Smooth – Complete Glow (Full Arms + Full Legs + Underarms)', price: 'AED 240.45' },
        { name: 'Silk Smooth – Full Body Glow (Without Bikini)', price: 'AED 418.95' },
        { name: 'Silk Smooth – Full Body Glow Deluxe (With Bikini)', price: 'AED 523.95' },
        { name: 'Gelish Pedicure + Gelish Manicure + Foot Massage', price: 'AED 300' },
        { name: 'Manicure + Pedicure + Foot Massage', price: 'AED 169' },
        { name: 'Blow Dry + Root Color Combo', price: 'AED 230' },
        { name: 'Hair Layer Cut', price: 'AED 189' },
        { name: 'Midday Glow – Hot Oil Head Massage', price: 'AED 105' },
        { name: 'Midday Glow – Basic Manicure & Pedicure', price: 'AED 135' },
        { name: 'Midday Glow – Head & Back Massage', price: 'AED 147' },
        { name: 'Midday Glow – Hair Spa', price: 'AED 156' },
        { name: 'Midday Glow – Basic Facial', price: 'AED 188' },
        { name: 'Midday Glow – Wash, Cut & Blow Dry', price: 'AED 198' },
        { name: 'Midday Glow – Relaxing Body Massage', price: 'AED 200' },
        { name: 'Midday Glow – Nail Extensions', price: 'AED 272' },
        { name: 'Beauty Package – Bud', price: 'AED 229' },
        { name: 'Beauty Package – Blossom', price: 'AED 279' },
        { name: 'Beauty Package – Petal', price: 'AED 319' },
        { name: 'Beauty Package – Bloom', price: 'AED 499' },
        { name: 'Beauty Package – Flourish', price: 'AED 599' },
        { name: 'Botox | Keratin | Nanoplastia | Protein Combo', price: 'AED 600' },
      ],
    },
    {
      id: 'special-offers',
      title: 'Special Offers',
      image: 'https://images.unsplash.com/photo-1562259920-47afc3030ba2?ixlib=rb-4.1.0&auto=format&fit=crop&q=80&w=1740',
      subservices: [
        { name: 'Monday Offer – Acrylic Mani + Pedi', price: 'AED 105' },
        { name: 'Monday Offer – Hair Wash + Blow Dry', price: 'AED 99' },
        { name: 'Monday Offer – Acrylic Full Set (Color)', price: 'AED 269' },
        { name: 'Midday Offer – Relaxing Body Massage', price: 'AED 178.50' },
        { name: 'Midday Offer – Hot Oil Head Massage', price: 'AED 84' },
      ],
    },
  ];
const phoneNumbers = [
