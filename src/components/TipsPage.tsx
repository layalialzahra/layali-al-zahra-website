  ...
  const tipsData = [
    {
      ...
      description:
        "Dubai's tap water has one of the highest mineral contents in the region — up to 500 mg/L of dissolved calcium and magnesium. These minerals coat the hair shaft, causing dullness, brittleness, and colour fading much faster than normal. If your hair feels rough or your colour isn't lasting between visits, hard water is very likely the reason.",
    ...
    },
    {
      ...
      description:
        "Dubai's summer UV index regularly hits 10–11 (Extreme), with temperatures exceeding 45°C from June through September. Direct sun exposure bleaches colour-treated hair, breaks down keratin bonds, and leaves hair dry and porous — whether you're commuting, at the beach, or walking between malls.",
      ...
      tips: [
        ...
        'Deep condition weekly during summer; the combination of heat, sea salt, chlorine, and AC makes hair particularly prone to breakage in this season',
      ],
    },
    {
      id: 3,
      ...
      description:
        'Most Dubai residents spend over 90% of their time in air-conditioned spaces. AC systems drop indoor humidity to 20–30%, continuously pulling moisture from the skin. This causes tightness, flakiness, and accelerated fine lines — and it compounds with Dubai's already low natural outdoor humidity outside the July–August peak.',
      image: '/tip-ac-skin-care.webp',
      tips: [
        'Switch from gel-based cleansers to cream or oil cleansers — they clean without stripping the skin's moisture barrier',
        ...
        'Carry a thermal facial mist (such as Avène or La Roche-Posay Thermal Water) for a midday refresh on long office days',
    ...
    },
    {
      ...
      description:
        'Dubai experiences dust storms (shamal winds) most frequently from March through May, and occasionally in autumn. Fine desert sand and grit settle on hair, block pores, and cause microscopic abrasion on the skin. A single sandstorm can undo a full week of careful skincare if you're not prepared.',
      ...
      tips: [
        ...
        'Cover hair with a scarf or tie it up in a loose bun before going outdoors in dusty conditions — open hair lets fine sand penetrate deep to the scalp',
        'Follow any dusty day with a clarifying shampoo wash, then a hydrating mask to restore moisture',
        'Avoid waxing, threading, or chemical facial treatments within 24 hours of heavy dust exposure — skin is already sensitised and prone to irritation',
    ...
    },
    {
      ...
      tips: [
        ...
        'Keratin and protein hair treatments need 7–10 days to fully settle — plan these well ahead, then book a wash and blow dry closer to the occasion',
        'Brides: always do a full trial session (makeup, hair, and henna) at least 4 weeks before the wedding — adjustments take time and communication',
      ],
    },
    {
      id: 6,
      ...
      tips: [
        ...
        'For colour-treated hair, book a protein bond treatment (such as Olaplex) monthly during heavy swimming periods to prevent colour lift and breakage',
      ],
    },
  ];
