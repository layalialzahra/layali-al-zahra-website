        ...
        <div className="min-h-screen pt-8 pb-20 bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100">
          <div className="container mx-auto px-4">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <Input id="name" name="name" type="text" value={formData.name} onChange={handleChange} required className="w-full" placeholder="Your name" />
                  </div>
                  <div>
                  ...
                  <Button type="submit" disabled={isSubmitting} className="w-full bg-rose-500 hover:bg-rose-600 text-white disabled:opacity-60">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <p className="text-center text-gray-600 mb-4">Check our services and Book your Appointment today.</p>
                    <Button onClick={() => onNavigate('services')} variant="outline" className="w-full border-rose-500 text-rose-500 hover:bg-rose-50">
                      Learn More
                    </Button>
                  </div>
                </form>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <div className="space-y-4">
                    <Button onClick={() => setShowPhoneDialog(true)} className="w-full bg-rose-500 hover:bg-rose-600 text-white justify-start">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@layalialzahra.com" className="text-rose-600 hover:text-rose-700">info@layalialzahra.com</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="space-y-1">
                          {phoneNumbers.map((phone, index) => (
                            <a key={index} href={phone.link} className="block text-rose-600 hover:text-rose-700 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        >
                          Shop No:1, Al Telal 11, Near Westzone Supermarket, Al Barsha 1, Dubai, United Arab Emirates
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-600">1:00 PM - 8:30 PM</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Dialog open={showPhoneDialog} onOpenChange={setShowPhoneDialog}>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle className="text-rose-900 text-center mb-4">Choose a Number to Call</DialogTitle>
                  <DialogDescription className="sr-only">Select a phone number to call us</DialogDescription>
                </DialogHeader>
                <div className="space-y-3">
                  {phoneNumbers.map((phone, index) => (
                    <a key={index} href={phone.link} className="flex items-center justify-between p-4 bg-rose-50 rounded-lg hover:bg-rose-100 transition-colors">
